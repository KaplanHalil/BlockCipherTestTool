...
def process_bit_p_rc(bit_index):
    """Process a single bit index for p-rc avalanche test"""
    ...
    for k in range(1000):
        ...
        # change value of bit
        plaintext_bits[bit_index] = plaintext_bits[bit_index]^1
...
if __name__ == "__main__":
    ...
    with Pool(processes=num_workers) as pool:
        results = pool.map(process_bit_p_rc, bit_indices)
    ...
    img.save(os.path.join(results_dir, "aval_p-rc.png"))
    b=time.time()
