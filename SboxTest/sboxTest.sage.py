...
_sage_const_1 = Integer(1); _sage_const_16 = Integer(16); _sage_const_6 = Integer(6); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0)# Add the Algorithm directory to the Python path
