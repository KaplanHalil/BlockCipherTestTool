...
_sage_const_1 = Integer(1); _sage_const_16 = Integer(16); _sage_const_6 = Integer(6); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_255 = Integer(255); _sage_const_2 = Integer(2); _sage_const_153 = Integer(153); _sage_const_76 = Integer(76); _sage_const_4 = Integer(4); _sage_const_204 = Integer(204); _sage_const_128 = Integer(128); _sage_const_8 = Integer(8); _sage_const_10 = Integer(10); _sage_const_12 = Integer(12); _sage_const_139 = Integer(139); _sage_const_69 = Integer(69); _sage_const_19 = Integer(19)
...
def create_image_from_2d_list(data):
    width, height = len(data[_sage_const_0 ]), len(data)
    img = Image.new("RGB", (width, height), "black")
    pixels = img.load()
    
    color_map = {
        _sage_const_0 : (_sage_const_255 , _sage_const_255 , _sage_const_255 ),  # White
        _sage_const_2 : (_sage_const_0 , _sage_const_153 , _sage_const_76 ),      # Green
        _sage_const_4 : (_sage_const_204 , _sage_const_204 , _sage_const_0 ),      # Yellow
        _sage_const_6 : (_sage_const_255 , _sage_const_128 , _sage_const_0 ),    # Orange
        _sage_const_8 : (_sage_const_255 , _sage_const_0 , _sage_const_0 ),      # Red
        _sage_const_10 : (_sage_const_204 , _sage_const_0 , _sage_const_0 ),      # Red
        _sage_const_12 : (_sage_const_153 , _sage_const_0 , _sage_const_0 ),      # Red
        _sage_const_16 : (_sage_const_139 , _sage_const_69 , _sage_const_19 )     # Brown
    }
    
    for y in range(height):
        for x in range(width):
            pixels[x, y] = color_map.get(data[y][x], (_sage_const_0 , _sage_const_0 , _sage_const_0 ))  # Default to black if value not in map
